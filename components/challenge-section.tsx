  ...
  return (
    <section id="challenge" className="relative py-24 sm:py-32 border-t border-border">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Problem area */}
        <StaggerContainer className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-border mb-24">
          <FadeInStaggerItem className="p-8 lg:p-10 flex flex-col items-center text-center group">
        ...
        {/* Focus Areas */}
        <FadeIn className="mb-24 relative">
        ...
        <FadeIn>
          ...
          <StaggerContainer className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12 relative max-w-5xl mx-auto">
            {/* Connecting line */}
            ...
            <FadeInStaggerItem className="flex-1 flex flex-col items-center text-center group">
