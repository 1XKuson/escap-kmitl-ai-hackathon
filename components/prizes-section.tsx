...
export function PrizesSection({ dict }: { dict: any }) {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            {dict.pool_label}{" "}
            <span className="text-primary font-bold text-2xl">{dict.pool_value}</span>
          </p>
        </FadeIn>

        {/* Prize podium */}
        <StaggerContainer className="flex flex-col md:flex-row items-center md:items-end justify-center gap-6 mb-24 min-h-[300px]">
          {/* 1st Runner Up */}
          <FadeInStaggerItem className="w-full md:w-1/3 flex flex-col items-center order-2 md:order-1 pt-10">
            <h3 className="text-3xl font-bold text-foreground mb-2" style={{ fontFamily: "var(--font-heading)" }}>{dict.prize_2_amount}</h3>
            <p className="text-sm text-muted-foreground mb-6 uppercase tracking-wider font-semibold">{dict.prize_2_label}</p>
          ...
          {/* Winner */}
          <FadeInStaggerItem className="w-full md:w-1/3 flex flex-col items-center order-1 md:order-2 z-10">
            ...
            <h3 className="text-4xl md:text-5xl font-extrabold text-primary mb-2 drop-shadow-sm" style={{ fontFamily: "var(--font-heading)" }}>{dict.prize_1_amount}</h3>
          ...
          {/* 2nd Runner Up */}
          <FadeInStaggerItem className="w-full md:w-1/3 flex flex-col items-center order-3 md:order-3 pt-16">
            <h3 className="text-2xl font-bold text-foreground mb-2" style={{ fontFamily: "var(--font-heading)" }}>{dict.prize_3_amount}</h3>
            <p className="text-sm text-muted-foreground mb-6 uppercase tracking-wider font-semibold">{dict.prize_3_label}</p>
        ...
        <FadeIn className="relative pt-16 mt-8">
          {/* Subtle separator */}
          ...
          <h3 className="text-lg font-bold text-muted-foreground mb-12 text-center uppercase tracking-[0.2em]" style={{ fontFamily: "var(--font-heading)" }}>
            {dict.intangible_title}
          </h3>
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <FadeInStaggerItem className="flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">{dict.ben1_title}</h4>
            ...
            <FadeInStaggerItem className="flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">{dict.ben2_title}</h4>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {dict.ben2_desc}
              </p>
            </FadeInStaggerItem>
            <FadeInStaggerItem className="flex flex-col items-center text-center group">
              ...
              <h4 className="text-lg font-bold text-foreground mb-2">{dict.ben3_title}</h4>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {dict.ben3_desc}
              </p>
            </FadeInStaggerItem>
